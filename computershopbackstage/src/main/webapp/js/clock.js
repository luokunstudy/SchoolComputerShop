...
var cmStr = new Array('日', '正', '二', '三', '四', '五', '六', '七', '八', '九', '十',
		'冬', '腊')
...
function solarDay() {
	...
	var solarTerm = new Array("小寒", "大寒", "立春", "雨水", "惊蛰", "春分", "清明", "谷雨",
			...
			"霜降", "立冬", "小雪", "大雪", "冬至")
	var lFtv = new Array("0101*春节", "0115 元宵节", "0505 端午节", "0707 七夕",
	...
	var sFtv = new Array("0101*元旦", "0214 情人节", "0308 妇女节", "0312 植树节",
			...
			"0701 建党节", "0801 建军节", "0811 记者日", "0910 教师节", "1001*国庆节",
			"1101 万圣节", "1225 圣诞节", "0511 母亲节", "0608 父亲节", "1129 感恩节")
	...
	if (lunarFestival == '') {
		...
		sFtv = lunarFestival
	if (sFtv == '')
		sTermInfo = cyclical(lDObj.year - 1900 + 36) + '年 '
				+ cDay(lDObj.month, lDObj.day)
	else
		sTermInfo = cDay(lDObj.month, lDObj.day) + ' <font color=#DF0A10>'
				+ sFtv + '</font>'
	return (sTermInfo)
}
function CurentTime() {
