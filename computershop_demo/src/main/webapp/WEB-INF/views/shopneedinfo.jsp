		...
		<div class="cont">
			...
			<div class="contRight" style="border: 0;">
				<div class="proBox">
								...
								<img width="300" height="300" src="../images/left.png" />
						
				
					<!--tsShopContainer/-->
					<div class="proBoxRight">
						<h3 class="proTitle">用户帐号：${goodsneedinfo.account}</h3>
						<div>商品名称：${goodsneedinfo.goodsName}</div><br>
						<div>交易方式：${goodsneedinfo.tradeMode}</div><br>	 
						<div><td>发布时间：<fmt:formatDate value="${goodsneedinfo.relaseTime}" pattern="yyyy-MM-dd"/></td></div><br>
						<div>联系方式：${goodsneedinfo.contact}</div><br>
						<div>商品描述：</div>
						<div><textarea style="margin-left: 0px;margin-right: 0px;width: 237px;height: 51px;border:0px;"  readonly>
						${goodsneedinfo.goodsDescribe}</textarea></div>
						<div class="gc">	
						</div>
						<!--gc/-->
					</div>
