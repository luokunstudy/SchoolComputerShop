...
<body>
	<div class="mianCont">
		...
		<div class="lsg">
			<h1 class="logo">
				<a href="index.html"><img src="../images/LOGO.png" width="217"
					height="90" /></a>
			</h1>
		...
		<!--pnt/-->
		<div class="positions">
			当前位置：<a href="#">首页</a> &gt; <a href="#" class="posCur">全部电脑</a>
		</div>
		<!--positions/-->
		<div class="cont">
			<div class="jilu">
			...
			<div class="contRight">
				<div class="frProList">
					...
					<c:forEach items="${newcomputer}" var="newcomputer">
						<dl>
							<dt>
								<a href="shopinfo?goodsId=${newcomputer.goodsId}"><img
									src="<%=basePath%>upload/${newcomputer.goodsPhone}" width="132"
									height="129" /></a>
							</dt>
							<dd>${newcomputer.goodsName}</dd>
							<dd class="cheng">
								￥${newcomputer.goodsPrice}/个 <span>￥${newcomputer.goodsOldprice}</span>
							</dd>
						</dl>
					</c:forEach>
					...
					<div class="scott">
						...
						<!-- 显示分页条 -->
						<!--${alltype.typeId}未知  -->
						<a href="listshop?typeId=${alltype.typeId}&pn=1">首页</a> 
						<c:if test="${pageInfo.hasPreviousPage}">
						<a href="listshop?typeId=${alltype.typeId}&pn=${pageInfo.pageNum-1}">&laquo;</a>
						</c:if> 
						<c:forEach items="${pageInfo.navigatepageNums}" var="pageNum" >	
						<a href="listshop?typeId=${alltype.typeId}&pn=${pageNum}">${pageNum}</a> 
						</c:forEach>
						<c:if test="${pageInfo.hasNextPage}">
						<a href="listshop?typeId=${alltype.typeId}&pn=${pageInfo.pageNum+1}">&raquo;</a>
						</c:if> 
						<a href="listshop?typeId=${alltype.typeId}&pn=${pageInfo.pages}">尾页</a>
					</div> --%>
				</div>
				<!--frProList-->
			</div>
