...
<body>
	<div class="mianCont">
			...
			<form action="vagueselect" method="post" class="subBox">
				<div class="subBoxDiv">
					...
					<div class="hotWord">
					    ...
					    <a href="listnewshop?goodsCategory=2&typeId=${alltype.typeId}">${alltype.goodsType}</a>
				        </c:forEach>
		...
		<div class="pnt">
			...
			<div class="pntRight">
				<ul class="nav">
					...
					<li class="navCur"><a href="listnewcomputer?goodsCategory=2">二手电脑</a></li>
		...
		<!--pnt/-->
		<div class="positions">
			当前位置：<a href="#">首页</a> &gt; <a href="#" class="posCur">二手电脑</a>
		</div>
		<!--positions/-->
		<div class="cont">
			<div class="jilu">
			...
			<div class="contLeft">
				<ul class="leftPorNav">
				    <c:forEach items="${alltype}" var="alltype">
					<li><a href="listnewshop?goodsCategory=2&typeId=${alltype.typeId}">${alltype.goodsType}</a></li>
					</c:forEach>	
				</ul>
				<!--InPorNav/-->
			</div>
			...
			<div class="contRight">
				<div class="frProList">
					...
					<c:forEach items="${pageInfo.list}" var="pageInfo">
						<dl>
							<dt>
								<a href="shopinfo?goodsId=${pageInfo.goodsId}">
								<img src="<%=basePath%>upload/${pageInfo.goodsPhone}" width="132" height="129"/>
								</a>
							</dt>
                 ...
                 <!-- 显示分页信息块 -->
					<div class="scott">
						...
						<br>
						<!-- 显示分页条 -->
						<a href="listnewcomputer?goodsCategory=2&pn=1">首页</a> 
						<c:if test="${pageInfo.hasPreviousPage}">
						<a href="listnewcomputer?goodsCategory=2&pn=${pageInfo.pageNum-1}">&laquo;</a>
						</c:if> 
						<c:forEach items="${pageInfo.navigatepageNums}" var="pageNum" >	
						<a href="listnewcomputer?goodsCategory=2&pn=${pageNum}">${pageNum}</a> 
						</c:forEach>
						<c:if test="${pageInfo.hasNextPage}">
						<a href="listnewcomputer?goodsCategory=2&pn=${pageInfo.pageNum+1}">&raquo;</a>
						</c:if> 
						<a href="listnewcomputer?goodsCategory=2&pn=${pageInfo.pages}">尾页</a>
					</div>
                   <br>
				</div>
				<!--frProList-->
