...
<body>
    <!--头部-->
    <div class="header">
        <div class="desc" style="margin-left:-200px">校园电脑商城》》</div>
    	...
    	<div class="register">
    		...
    		<div class="register-box">
    			...
    			<div class="box default">
    				...
    				<input type="text" id="userName" name="account" placeholder="您的账户名和登录名" />
    				<i></i>
    			</div>
    			<!--提示信息-->
    			<div class="tip">
            ...
            <!--选择性别-->
            <div class="register-box" style="margin-left:7px;margin-top: 25px">
                  <label for="pwd2">选 择 性 别</label>&nbsp&nbsp
                    <input type="radio"  name="sex" value="1"/>男&nbsp&nbsp
    		...
    		<div class="register-box">
    			...
    			<div class="box default">
    				...
    				<input type="text" id="mobile" name="telephone" placeholder="请输入手机号" />
    				<i></i>
    			</div>
    			<!--提示信息-->
    			<div class="tip">
    		...
    		<div class="register-box xieyi">
    			...
    			<div class="box default">
    				...
    				<span>我已阅读并同意<a href="##">《校园电脑商城协议》</a></span>
    			</div>
    			<!--提示信息-->
    			<div class="tip">
    				<i></i>
